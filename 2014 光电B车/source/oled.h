 ...
 * 宏定义                                                                     *
 *----------------------------------------------------------------------------*/
#define LED_SCL       PTM_PTM1  
#define LED_SDA       PTM_PTM2
#define LED_RST       PTM_PTM3 
#define LED_DC        PTM_PTM4
#define LED_CS        PTM_PTM5 
#define LED_PORT      DDRM
...
extern VOID LED_PrintImage(UCHAR8 *pucTable,USHORT16 Start_Show_Line, USHORT16 usRowNum, USHORT16 usColumnNum);
extern void Show_Welcome_Picture(void);
